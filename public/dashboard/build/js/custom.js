	   ...
	   /* CUSTOM NOTIFICATION */
		...
		function init_charts() {
			...
			if ($('#DP17_previus').length ){	
			    ...
			    $.get("/gr_reports/DP17/"+id_equipo+"/" + mesAnterior +"/"+ anio,function(response) {	
			    	var fecha; var dia;
			        for(i=0; i<response.length; i++){
			        	fecha = response[i].date;
			        	fecha = fecha.split("-");
			        	dia = fecha[2] + "-" + meses[(fecha[1]-1)];
			            arrdp17Xp.push(dia);
			            arrdp17Yp.push(response[i].value);
			        }
			...
			if ($('#DP18_current').length ){	
			    ...
			    $.get("/gr_reports/DP18/"+id_equipo+"/"+ mesActual +"/"+ anio,function(response) {	
			    	var fecha; var dia;
			        for(i=0; i<response.length; i++){
			        	fecha = response[i].date;
			        	fecha = fecha.split("-");
			        	dia = fecha[2] + "-" + meses[(fecha[1]-1)];
			            arrdp18X.push(dia);
			            arrdp18Y.push(response[i].value);
			        }
			...
			if ($('#DP18_previus').length ){	
			    ...
			    $.get("/gr_reports/DP18/"+id_equipo+"/" + mesAnterior +"/"+ anio,function(response) {	
			    	var fecha; var dia;
			        for(i=0; i<response.length; i++){
			        	fecha = response[i].date;
			        	fecha = fecha.split("-");
			        	dia = fecha[2] + "-" + meses[(fecha[1]-1)];
			            arrdp18Xp.push(dia);
			            arrdp18Yp.push(response[i].value);
			        }
			...
			// DP19			
			if ($('#DP19_current').length ){	
				
				var id_equipo = $('#id_equipo').val();
				var arrdp19X = new Array('0');
				var arrdp19Y = new Array('0');
			    $.get("/gr_reports/DP19/"+id_equipo+"/"+ mesActual +"/"+ anio,function(response) {	
			    	var fecha; var dia;
			        for(i=0; i<response.length; i++){
			        	fecha = response[i].date;
			        	fecha = fecha.split("-");
			        	dia = fecha[2] + "-" + meses[(fecha[1]-1)];
			            arrdp19X.push(dia);
			            arrdp19Y.push(response[i].value);
			        }

			  var ctx = document.getElementById("DP19_current");
			  var lineChart = new Chart(ctx, {
				type: 'line',
				data: {
				  labels: arrdp19X,
			...
			if ($('#DP19_previus').length ){	
				
				var id_equipo = $('#id_equipo').val();
				var arrdp19Xp = new Array('0');
				var arrdp19Yp = new Array('0');
			    $.get("/gr_reports/DP19/"+id_equipo+"/" + mesAnterior +"/"+ anio,function(response) {	
			    	var fecha; var dia;
			        for(i=0; i<response.length; i++){
			        	fecha = response[i].date;
			        	fecha = fecha.split("-");
			        	dia = fecha[2] + "-" + meses[(fecha[1]-1)];
			            arrdp19Xp.push(dia);
			            arrdp19Yp.push(response[i].value);
			        }

			  var ctx = document.getElementById("DP19_previus");
			  var lineChart = new Chart(ctx, {
				type: 'line',
				data: {
				  labels: arrdp19Xp,
			...
			if ($('#DP30_current').length ){	
			    ...
			    $.get("/gr_reports/DP30/"+id_equipo+"/"+ mesActual +"/"+ anio,function(response) {	
			    	var fecha; var dia;
			        for(i=0; i<response.length; i++){
			        	fecha = response[i].date;
			        	fecha = fecha.split("-");
			        	dia = fecha[2] + "-" + meses[(fecha[1]-1)];
			            arrdp30X.push(dia);
			            arrdp30Y.push(response[i].value);
			        }
			...
			if ($('#DP30_previus').length ){	
			    ...
			    $.get("/gr_reports/DP30/"+id_equipo+"/" + mesAnterior +"/"+ anio,function(response) {	
			    	var fecha; var dia;
			        for(i=0; i<response.length; i++){
			        	fecha = response[i].date;
			        	fecha = fecha.split("-");
			        	dia = fecha[2] + "-" + meses[(fecha[1]-1)];
			            arrdp30Xp.push(dia);
			            arrdp30Yp.push(response[i].value);
			        }
			...
			// DP31
			if ($('#DP31_current').length ){	
				
				var id_equipo = $('#id_equipo').val();
				var arrdp31X = new Array('0');
				var arrdp31Y = new Array('0');
			    $.get("/gr_reports/DP31/"+id_equipo+"/"+ mesActual +"/"+ anio,function(response) {	
			    	var fecha; var dia;
			        for(i=0; i<response.length; i++){
			        	fecha = response[i].date;
			        	fecha = fecha.split("-");
			        	dia = fecha[2] + "-" + meses[(fecha[1]-1)];
			            arrdp31X.push(dia);
			            arrdp31Y.push(response[i].value);
			        }

			  var ctx = document.getElementById("DP31_current");
			  var lineChart = new Chart(ctx, {
				type: 'line',
				data: {
				  labels: arrdp31X,
			...
			if ($('#DP31_previus').length ){	
				
				var id_equipo = $('#id_equipo').val();
				var arrdp31Xp = new Array('0');
				var arrdp31Yp = new Array('0');
			    $.get("/gr_reports/DP31/"+id_equipo+"/" + mesAnterior +"/"+ anio,function(response) {	
			    	var fecha; var dia;
			        for(i=0; i<response.length; i++){
			        	fecha = response[i].date;
			        	fecha = fecha.split("-");
			        	dia = fecha[2] + "-" + meses[(fecha[1]-1)];
			            arrdp31Xp.push(dia);
			            arrdp31Yp.push(response[i].value);
			        }

			  var ctx = document.getElementById("DP31_previus");
			  var lineChart = new Chart(ctx, {
				type: 'line',
				data: {
				  labels: arrdp31Xp,
			...
			//DP32
			if ($('#DP32_current').length ){	
				
				var id_equipo = $('#id_equipo').val();
				var arrdp32X = new Array('0');
				var arrdp32Y = new Array('0');
			    $.get("/gr_reports/DP32/"+id_equipo+"/"+ mesActual +"/"+ anio,function(response) {	
			    	var fecha; var dia;
			        for(i=0; i<response.length; i++){
			        	fecha = response[i].date;
			        	fecha = fecha.split("-");
			        	dia = fecha[2] + "-" + meses[(fecha[1]-1)];
			            arrdp32X.push(dia);
			            arrdp32Y.push(response[i].value);
			        }

			  var ctx = document.getElementById("DP32_current");
			  var lineChart = new Chart(ctx, {
				type: 'line',
				data: {
				  labels: arrdp32X,
			...
			if ($('#DP32_previus').length ){	
				
				var id_equipo = $('#id_equipo').val();
				var arrdp32Xp = new Array('0');
				var arrdp32Yp = new Array('0');
			    $.get("/gr_reports/DP32/"+id_equipo+"/" + mesAnterior +"/"+ anio,function(response) {	
			    	var fecha; var dia;
			        for(i=0; i<response.length; i++){
			        	fecha = response[i].date;
			        	fecha = fecha.split("-");
			        	dia = fecha[2] + "-" + meses[(fecha[1]-1)];
			            arrdp32Xp.push(dia);
			            arrdp32Yp.push(response[i].value);
			        }

			  var ctx = document.getElementById("DP32_previus");
			  var lineChart = new Chart(ctx, {
				type: 'line',
				data: {
				  labels: arrdp32Xp,
			...
			//DP34
			if ($('#DP34_current').length ){	
				
				var id_equipo = $('#id_equipo').val();
				var arrdp34X = new Array('0');
				var arrdp34Y = new Array('0');
			    $.get("/gr_reports/DP34/"+id_equipo+"/"+ mesActual +"/"+ anio,function(response) {	
			    	var fecha; var dia;
			        for(i=0; i<response.length; i++){
			        	fecha = response[i].date;
			        	fecha = fecha.split("-");
			        	dia = fecha[2] + "-" + meses[(fecha[1]-1)];
			            arrdp34X.push(dia);
			            arrdp34Y.push(response[i].value);
			        }

			  var ctx = document.getElementById("DP34_current");
			  var lineChart = new Chart(ctx, {
				type: 'line',
				data: {
				  labels: arrdp34X,
			...
			if ($('#DP34_previus').length ){	
				
				var id_equipo = $('#id_equipo').val();
				var arrdp34Xp = new Array('0');
				var arrdp34Yp = new Array('0');
			    $.get("/gr_reports/DP34/"+id_equipo+"/" + mesAnterior +"/"+ anio,function(response) {	
			    	var fecha; var dia;
			        for(i=0; i<response.length; i++){
			        	fecha = response[i].date;
			        	fecha = fecha.split("-");
			        	dia = fecha[2] + "-" + meses[(fecha[1]-1)];
			            arrdp34Xp.push(dia);
			            arrdp34Yp.push(response[i].value);
			        }

			  var ctx = document.getElementById("DP34_previus");
			  var lineChart = new Chart(ctx, {
				type: 'line',
				data: {
				  labels: arrdp34Xp,
			...
			//DP44
			if ($('#DP44_current').length ){	
				
				var id_equipo = $('#id_equipo').val();
				var arrdp44X = new Array('0');
				var arrdp44Y = new Array('0');
			    $.get("/gr_reports/DP44/"+id_equipo+"/"+ mesActual +"/"+ anio,function(response) {	
			    	var fecha; var dia;
			        for(i=0; i<response.length; i++){
			        	fecha = response[i].date;
			        	fecha = fecha.split("-");
			        	dia = fecha[2] + "-" + meses[(fecha[1]-1)];
			            arrdp44X.push(dia);
			            arrdp44Y.push(response[i].value);
			        }

			  var ctx = document.getElementById("DP44_current");
			  var lineChart = new Chart(ctx, {
				type: 'line',
				data: {
				  labels: arrdp44X,
			...
			if ($('#DP44_previus').length ){	
				
				var id_equipo = $('#id_equipo').val();
				var arrdp44Xp = new Array('0');
				var arrdp44Yp = new Array('0');
			    $.get("/gr_reports/DP44/"+id_equipo+"/" + mesAnterior +"/"+ anio,function(response) {	
			    	var fecha; var dia;
			        for(i=0; i<response.length; i++){
			        	fecha = response[i].date;
			        	fecha = fecha.split("-");
			        	dia = fecha[2] + "-" + meses[(fecha[1]-1)];
			            arrdp44Xp.push(dia);
			            arrdp44Yp.push(response[i].value);
			        }

			  var ctx = document.getElementById("DP44_previus");
			  var lineChart = new Chart(ctx, {
				type: 'line',
				data: {
				  labels: arrdp44Xp,
			...
			//DP49
			if ($('#DP49_current').length ){	
				
				var id_equipo = $('#id_equipo').val();
				var arrdp49X = new Array('0');
				var arrdp49Y = new Array('0');
			    $.get("/gr_reports/DP49/"+id_equipo+"/"+ mesActual +"/"+ anio,function(response) {	
			    	var fecha; var dia;
			        for(i=0; i<response.length; i++){
			        	fecha = response[i].date;
			        	fecha = fecha.split("-");
			        	dia = fecha[2] + "-" + meses[(fecha[1]-1)];
			            arrdp49X.push(dia);
			            arrdp49Y.push(response[i].value);
			        }

			  var ctx = document.getElementById("DP49_current");
			  var lineChart = new Chart(ctx, {
				type: 'line',
				data: {
				  labels: arrdp49X,
			...
			if ($('#DP49_previus').length ){	
				
				var id_equipo = $('#id_equipo').val();
				var arrdp49Xp = new Array('0');
				var arrdp49Yp = new Array('0');
			    $.get("/gr_reports/DP49/"+id_equipo+"/" + mesAnterior +"/"+ anio,function(response) {	
			    	var fecha; var dia;
			        for(i=0; i<response.length; i++){
			        	fecha = response[i].date;
			        	fecha = fecha.split("-");
			        	dia = fecha[2] + "-" + meses[(fecha[1]-1)];
			            arrdp49Xp.push(dia);
			            arrdp49Yp.push(response[i].value);
			        }

			  var ctx = document.getElementById("DP49_previus");
			  var lineChart = new Chart(ctx, {
				type: 'line',
				data: {
				  labels: arrdp49Xp,
			...
			if ($('#DP0_current').length ){ 
				
				var id_equipo = $('#id_equipo').val();
				var arrdp0X = new Array();
				var arrdp0Y = new Array();
				
			    $.get("/gr_reports_event/2/"+id_equipo+"/" + mesActual +"/"+ anio,function(response) {	
			    	var fecha; var dia;
			        for(i=0; i<response.length; i++){
			        	fecha = response[i].date;
			        	fecha = fecha.split("-");
			        	dia = fecha[2] + "-" + meses[(fecha[1]-1)];
			            arrdp0X.push(dia);
			            arrdp0Y.push(response[i].total);
			        }	
			  
			  var ctx = document.getElementById("DP0_current");
			...
			if ($('#DP0_previus').length ){ 
				
				var id_equipo = $('#id_equipo').val();
				var arrdp0Xp = new Array();
				var arrdp0Yp = new Array();
			    $.get("/gr_reports_event/2/"+id_equipo +"/"+ mesAnterior +"/"+ anio,function(response) {	
			    	var fecha; var dia;
			        for(i=0; i<response.length; i++){
			        	fecha = response[i].date;
			        	fecha = fecha.split("-");
			        	dia = fecha[2] + "-" + meses[(fecha[1]-1)];
			            arrdp0Xp.push(dia);
			            arrdp0Yp.push(response[i].total);
			        }
